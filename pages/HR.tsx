    ...
    <div className="space-y-6">
      ...
      {employees.length === 0 ? (
        <div className="bg-white rounded-xl border border-slate-200 p-12 text-center flex flex-col items-center">
           ...
           <h3 className="text-lg font-bold text-slate-900">No Employees Added</h3>
           <p className="text-slate-500 mb-6">Build your team by adding your first employee.</p>
           <button onClick={() => setShowAddModal(true)} className="bg-blue-800 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-900">Register Staff</button>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button 
            onClick={() => setShowAddModal(true)}
            className="border-2 border-dashed border-slate-200 rounded-xl p-6 flex flex-col items-center justify-center text-slate-400 hover:border-blue-400 hover:text-blue-500 transition-colors"
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
           <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-2xl animate-fade-in relative">
              ...
              <div className="space-y-4">
                 <div>
                    ...
                    <input 
                      ...
                      className="w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-800 outline-none" 
                    />
                 </div>
              ...
              <div className="mt-8 flex justify-end space-x-3">
                 ...
                 <button onClick={handleAddEmployee} className="px-6 py-2 bg-blue-800 text-white font-medium hover:bg-blue-900 rounded-lg">Add Employee</button>
              </div>
           </div>
        </div>
      )}
