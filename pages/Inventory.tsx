      ...
      <div className="border-b border-slate-200">
        <nav className="-mb-px flex space-x-8">
          <button
            ...
            className={`${activeTab === 'stock' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-700'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
          >
            Stock Levels
          </button>
          <button
            onClick={() => setActiveTab('orders')}
            className={`${activeTab === 'orders' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-700'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
          >
            Purchase Orders
          </button>
        </nav>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
           <div className="bg-white rounded-xl w-full max-w-lg p-6 shadow-2xl animate-fade-in">
              ...
              <div className="mt-8 flex justify-end space-x-3">
                 ...
                 <button onClick={handleAddItem} className="px-6 py-2 bg-indigo-600 text-white font-medium hover:bg-indigo-700 rounded-lg">Save Product</button>
              </div>
           </div>
        </div>
      )}
